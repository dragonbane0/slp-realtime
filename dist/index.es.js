import { Subject as Subject$1, BehaviorSubject, merge, ReplaySubject, fromEvent } from "rxjs";
import { get, sumBy, shuffle } from "lodash";
import {
  Character,
  Stage,
  stages,
...
function extractPlayerNamesByPort(settings, metadata) {
  return [0, 1, 2, 3].map((index) => {
    ...
    const netplayName =
      (_a = get(metadata, ["players", index, "names", "netplay"], null)) !== null && _a !== void 0
        ? _a
        : player === null || player === void 0
        ? void 0
        : player.displayName;
    const netplayCode =
      (_b = get(metadata, ["players", index, "names", "code"], null)) !== null && _b !== void 0
        ? _b
        : player === null || player === void 0
        ? void 0
        : player.connectCode;
...
class ConversionEvents {
  constructor(stream) {
    ...
    this.end$ = fromEvent(this.conversionComputer, "CONVERSION").pipe(share());
    this.stream$ = stream;
...
class ComboEvents {
  constructor(stream) {
    ...
    this.start$ = fromEvent(this.comboComputer, "COMBO_START").pipe(share());
    this.extend$ = fromEvent(this.comboComputer, "COMBO_EXTEND").pipe(share());
    this.end$ = fromEvent(this.comboComputer, "COMBO_END").pipe(share());
    this.stream$ = stream;
